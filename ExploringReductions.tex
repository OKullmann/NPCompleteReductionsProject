...
\begin{defi}\label{def:CNF}
  A \textbf{CNF} (``CNF formula'') is XXX a conjunctive normal form formula is a conjunction of clauses, whereby each clause is a disjunction of literals.
\end{defi}

\begin{defi}\label{def:CLS}
  A \textbf{clause-set} is XXX a clause-set is a set with clause as it's elements.
\end{defi}
...
\begin{defi}\label{def:complexityclass}
  A \textbf{complexity class} is XXX A complexity class is a set of problems that requires the similar amount of resources to solve, such as size of input required and time requied to solve.
\end{defi}
